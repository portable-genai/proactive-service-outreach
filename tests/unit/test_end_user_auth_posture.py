...
read
    ...
    bind_profile == local AND profile chosen AND OUTREACH_S2S_TOKEN unset
...
approver's groups and tenant, and ``/v1/outreach/evaluate`` with a real held decision written
...
from proactive_outreach.adapters.local.identity import (
    LocalIdentityAdapter,
)
from proactive_outreach.adapters.onprem.identity import (
