# Proactive Service Outreach (E5) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    OUTREACH_PROFILE=gcp \
    OUTREACH_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn proactive_outreach.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
